...
class Backend {
  ...
  //Create
Future<void> insertUserData(String name, String age, String gender, String imgurl) async {
...
//   final url = Uri.parse(
//       'https://v6.exchangerate-api.com/v6/b2cd243453688f5ef8eab529/latest/$baseCurrency');
