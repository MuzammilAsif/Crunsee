...
import 'package:crunsee/views/ContactSupportScreen.dart';
import 'package:crunsee/views/ConversionHistoryScreen.dart';
import 'package:crunsee/views/FAQScreen.dart';
import 'package:crunsee/views/FeedbackScreen.dart';
import 'package:crunsee/views/MainScreen.dart';
import 'package:crunsee/views/UserPreferencesScreen.dart';
  ...
  Widget build(BuildContext context) {
    return GetMaterialApp(
      ...
      routes: {
        ...
        '/history': (context) => const ConversionHistoryScreen(),
      },
    );
  }
}
